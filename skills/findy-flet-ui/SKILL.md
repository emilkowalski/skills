...
```bash
PYTHONPYCACHEPREFIX=/private/tmp/findy_pycache python3 -m py_compile main.py app/runtime.py
PYTHONPYCACHEPREFIX=/private/tmp/findy_pycache python3 -m unittest discover -s tests -p 'test_*.py'
PYTHONPYCACHEPREFIX=/private/tmp/findy_pycache python3 tests/smoke.py
